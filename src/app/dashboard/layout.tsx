          ...
          {isLoadingUser ? (
            ...
            <div className="relative">
                ...
                <Avatar className="relative h-10 w-10 border-2 border-background">
                    <AvatarImage data-ai-hint="logo" src="https://i.ibb.co/W4PR2Pw2/Whats-App-Image-2025-07-09-at-11-21-29-ca10852e.jpg" alt="App Logo" />
                    <AvatarFallback className="bg-card text-primary">{userInitial}</AvatarFallback>
                </Avatar>
            </div>
          )}
        </header>
        <div className="flex-1 overflow-y-auto bg-background dark:bg-background text-foreground light:bg-[#f9fafb]">
            {children}
        </div>
      </SidebarInset>
    </SidebarProvider>
