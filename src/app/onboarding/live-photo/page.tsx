        ...
        default:
            return (
                <div className="flex flex-col items-center justify-center h-full">
                    <div className={cn("relative w-full aspect-video rounded-lg bg-black overflow-hidden flex items-center justify-center border-2 border-transparent", verificationState === 'camera' && 'border-primary')}>
