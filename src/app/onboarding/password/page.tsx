...
import { CheckCircle, Circle, Lock, Loader2, ShieldCheck } from "lucide-react"
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black text-white">
      ...
      <main className="relative z-20 flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-black/20 p-8 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
