  ...
  for (let attempt = 1; attempt <= maxRetries; attempt++) {
      try {
        ...
        Your goal is to be a trusted digital companion for the user.`,
          ...
          // Check for API not enabled error. This is a critical, non-retriable error.
          ...
          return "I'm sorry, I'm having trouble responding right now. The AI service may be temporarily unavailable. Please try again in a few moments.";
      }
  }
