...
export const locationData: Record<string, CountryConfig> = {
  ...
  "india": {
    ...
    regions: [
      ...
      { name: "Andhra Pradesh", cities: ["Visakhapatnam", "Vijayawada", "Guntur", "Nellore", "Tirupati", "Kurnool", "Kakinada", "Rajahmundry", "Anantapur"] },
      { name: "Arunachal Pradesh", cities: ["Itanagar", "Tawang", "Naharlagun"] },
      { name: "Assam", cities: ["Guwahati", "Dispur", "Dibrugarh", "Silchar", "Jorhat"] },
      ...
      { name: "Haryana", cities: ["Faridabad", "Gurgaon", "Panipat", "Ambala", "Yamunanagar", "Rohtak", "Hisar", "Karnal", "Sonipat"] },
      { name: "Himachal Pradesh", cities: ["Shimla", "Dharamshala", "Manali", "Solan", "Kullu", "Mandi"] },
      ...
      { name: "Karnataka", cities: ["Bengaluru", "Mysuru", "Hubballi-Dharwad", "Mangaluru", "Belagavi", "Davanagere", "Ballari", "Shivamogga", "Udupi"] },
      ...
      { name: "Madhya Pradesh", cities: ["Indore", "Bhopal", "Jabalpur", "Gwalior", "Ujjain", "Sagar", "Rewa"] },
      { name: "Maharashtra", cities: ["Mumbai", "Pune", "Nagpur", "Thane", "Nashik", "Aurangabad", "Solapur", "Navi Mumbai", "Amravati", "Kolhapur"] },
      ...
      { name: "Odisha", cities: ["Bhubaneswar", "Cuttack", "Rourkela", "Puri", "Sambalpur", "Berhampur"] },
      ...
      { name: "Tamil Nadu", cities: ["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tirunelveli", "Erode", "Vellore", "Thoothukudi"] },
      { name: "Telangana", cities: ["Hyderabad", "Warangal", "Nizamabad", "Karimnagar", "Ramagundam", "Khammam"] },
      { name: "Tripura", cities: ["Agartala"] },
      { name: "Uttar Pradesh", cities: ["Lucknow", "Kanpur", "Ghaziabad", "Agra", "Varanasi", "Meerut", "Prayagraj", "Noida", "Bareilly", "Gorakhpur", "Aligarh", "Moradabad"] },
      { name: "Uttarakhand", cities: ["Dehradun", "Haridwar", "Roorkee", "Haldwani", "Rishikesh", "Nainital"] },
      { name: "West Bengal", cities: ["Kolkata", "Howrah", "Asansol", "Siliguri", "Durgapur", "Darjeeling", "Haldia"] },
    ],
  },
  "indonesia": {
    label: "Indonesia",
